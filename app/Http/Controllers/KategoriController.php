...
class KategoriController extends Controller
{
    ...
    public function save(Request $req)
    {
        \Validator::make($req->all(),[
                'tbl_kategori'=>'required|between:3,100|unique:tbl_kategori,nama_kategori',])->validate();
         
    	 $result = new Kategori;
         $result->nama_kategori = $req->tbl_kategori;
    ...
    {
        \Validator::make($req->all(),[
                'nama_kategori'=>'required|between:3,100|unique:tbl_kategori,nama_kategori,'.$req->id,
        ])->validate();
