...
<html lang="en">
  ...
  <head>
    ...
    <title>@yield('title') AplikasirMelia</title>
    <link rel="icon" type="image/png" href="{{url('wage.png')}}">
    <!-- Bootstrap core CSS-->
  ...
  <body id="page-top">
    ...
    <script src="{{url('theme-sbadmin/vendor/datatables/jquery.dataTables.js')}}"></script>
    <script src="{{url('theme-sbadmin/vendor/datatables/dataTables.bootstrap4.js')}}"></script>
    <script src="{{url('theme-sbadmin/js/demo/datatables-demo.js')}}"></script>
    <script>
