		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group form-label-group">
					<input type="text" name="tbl_kategori"
					class="form-control {{ $errors->has('tbl_kategori')?'is-invalid':'' }}"
					value="{{ old('tbl_kategori') }}"
					id="iKategori" placeholder="Kategori" required>
					<label for="iKategori">Kategori</label>
					@if( $errors->has('tbl_kategori') )
					<div class="invalid-feedback">{{ $errors->first('tbl_kategori')}}</div>
					@endif
				</div><!-- End Form Group-->
			</div><!-- End Card Body-->
