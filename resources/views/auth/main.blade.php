...
<html lang="en">
  ...
  <head>
    ...
    <title>Aplikasir - @yield('title')</title>
    <link rel="icon" type="png/image" href="{{ url('wage.png') }}">
  ...
  <body class="bg-dark" style="background-image: url('images/4.jpg'); background-repeat: no-repeat;" >
